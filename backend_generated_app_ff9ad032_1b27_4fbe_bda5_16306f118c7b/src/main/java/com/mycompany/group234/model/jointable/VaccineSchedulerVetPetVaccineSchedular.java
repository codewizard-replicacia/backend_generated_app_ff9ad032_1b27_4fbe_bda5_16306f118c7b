...
@Entity(name = "VaccineSchedulerVetPetVaccineSchedular")
@Table(schema = "\"generated_app\"", name = "\"VaccineSchedulerVetPetVaccineSchedular\"")
@Data
public class VaccineSchedulerVetPetVaccineSchedular{
