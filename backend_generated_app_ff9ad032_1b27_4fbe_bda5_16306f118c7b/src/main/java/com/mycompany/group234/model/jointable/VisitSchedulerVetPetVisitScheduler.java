...
@Entity(name = "VisitSchedulerVetPetVisitScheduler")
@Table(schema = "\"generated_app\"", name = "\"VisitSchedulerVetPetVisitScheduler\"")
@Data
public class VisitSchedulerVetPetVisitScheduler{
