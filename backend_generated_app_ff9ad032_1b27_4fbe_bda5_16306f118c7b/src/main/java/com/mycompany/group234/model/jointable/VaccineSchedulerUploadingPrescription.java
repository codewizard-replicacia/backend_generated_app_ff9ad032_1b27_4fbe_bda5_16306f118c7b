...
@Entity(name = "VaccineSchedulerUploadingPrescription")
@Table(schema = "\"generated_app\"", name = "\"VaccineSchedulerUploadingPrescription\"")
@Data
public class VaccineSchedulerUploadingPrescription{
